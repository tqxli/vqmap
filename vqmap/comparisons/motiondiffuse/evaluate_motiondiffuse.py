...
def main(
    ...
    opt = get_opt(generator_checkpoint, device)
    opt.dim_pose = 69
    ...
    dataset = prepare_dataloaders(classifer_config.dataloader, split='val')['val'].dataset
    ...
    for seed in allseeds:
        ...
        for i in range(n_samples//100):
            output = trainer.generate_batch(torch.tensor([opt.max_motion_length]*100), opt.dim_pose)
